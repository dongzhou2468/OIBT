...
<script  type="text/javascript">
    ...
    <?php
        include('libs/Controller/indexController.class.php');
        $var = indexController::$str;
        echo $var;
        var_dump($_POST[0]);
//        $num = mysql_num_rows(indexController::$str);
//        echo $num;
//        for($a = 0; $a < $num; $a++){
//            $row = mysql_fetch_assoc(indexController::$str);
//            var_dump($row);
//        }
    ?>
