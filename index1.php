	...
	<div id="top">
		<div class="wp" style="height:35px;font-size: 14px;">
			...
			<div class="y" style="padding-top: 2px">
				<a href="#" class="test" onclick="showFloat()">登录</a>
				<a href="#">资讯</a>
				<a href="#">关于我们</a>
			</div>
		</div>
...
<div class="mid" style="height: 2000px; top:5px;">
    ...
    <div class="big right" style="top:22px;">
        <ul>
            <?php
            require('libs/Controller/indexController.class.php');
            ...
            <li id="1416795630" class="apk_infos">
                <a href="#"><img src="res/img/index/molishipin.png" alt="魔力视频"></a>
                ...
                <span class="apk_tag">分类标签：<?php echo indexController::$str ?></span>
